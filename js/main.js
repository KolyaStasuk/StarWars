...
ShowPeople = ({results}) => {
  ...
  for(i=0;i<10;i++)
  {
    ...
    /*div.appendChild(height);
     ...
     height.textContent = results[i].height;
     mass.textContent = results[i].mass;
     hair_color.textContent = results[i].hair_color;
     skin_color.textContent = results[i].skin_color;
     eye_color.textContent = results[i].eye_color;
     birth_year.textContent = results[i].birth_year;
     gender.textContent = results[i].gender;
  }
};
